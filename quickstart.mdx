...
<CardGroup cols={2}>
  <Card title="Benchmark Users" icon="users" iconType="regular" href="/tutorial/developers.mdx">
    Start your BenchFlow journey as Users.
  </Card>

  <Card title="Benchmark Developers" icon="laptop" iconType="regular" href="/tutorial/developers.mdx">
